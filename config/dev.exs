...
config :kith, KithWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "EXBpPEz7dKKkxej7BEMOEryGVEwEHrBGaxvjCdFqI5EB8G0lfweuXFwQ7q1jeRLC",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:kith, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:kith, ~w(--watch)]}
  ]
...
config :kith, KithWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/kith_web/router\.ex$",
      ~r"lib/kith_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
