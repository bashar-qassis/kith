      ...
      <div :if={@step == 1} class="mt-6">
        <div class="bg-white border rounded-lg p-6">
          <p class="text-sm text-gray-600 mb-4">
            Merging from: <span class="font-semibold">{@contact_a.display_name}</span>
          </p>
          <p class="text-sm text-gray-600 mb-4">
          ...
          <div :if={@search_results != []} class="mt-4 border rounded-md divide-y">
            ...
            >
              <div>
                ...
                <span :if={contact.company} class="text-sm text-gray-500 ml-2">
                  {contact.company}
                </span>
              </div>
          ...
          <p :if={@search_query != "" && @search_results == []} class="mt-4 text-sm text-gray-500">
      ...
      <div :if={@step == 2 && @contact_b} class="mt-6">
        <div class="bg-white border rounded-lg p-6">
          <div class="grid grid-cols-3 gap-4 mb-4 text-sm font-semibold text-gray-700">
            <div>Field</div>
            <div>{@contact_a.display_name} (A)</div>
            <div>{@contact_b.display_name} (B)</div>
          </div>
